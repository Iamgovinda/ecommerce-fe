        ...
        <div className={styles["parent"]}>
            <Container>
                <Grid container gap={6}>
                    ...
                    <Grid item md={5} alignItems='flex-end' className={styles['feature-section']}>
                        ...
                        <div className={styles['feature-section-items']}>
                            ...
                            <p className={styles['features']}>Reinforced with double wood dowels, glue, screw - nails corner
                            blocks and machine nails</p>
                        </div>
                        <div className={styles['feature-section-items']}>
                            <div className={styles['feature-section-bullet4']}></div>
